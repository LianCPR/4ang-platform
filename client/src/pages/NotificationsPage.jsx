...
const NOTIF_CONFIG = {
  ...
  TRACK_PUBLISHED: { icon: CheckCircle, color: "#4caf50", label: "Đã xuất bản" },
  ...
  ARTIST_REJECTED: { icon: AlertTriangle, color: "#e74c3c", label: "Yêu cầu" },
  ARTIST_VERIFIED: { icon: Shield, color: "var(--c-sage-deep)", label: "Xác minh" },
  ARTIST_VERIFICATION_REJECTED: { icon: AlertTriangle, color: "#e74c3c", label: "Xác minh" },
  SUBMISSION_APPROVED: { icon: CheckCircle, color: "#4caf50", label: "Đã duyệt" },
  SUBMISSION_REJECTED: { icon: XCircle, color: "#e74c3c", label: "Bị từ chối" },
